...
using Expense_Pro.Models;

namespace Expense_Pro.Controllers
{
    public class CategoryController : Controller
    {
        ...
        // GET: Categoriy/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Categoriy/Create
